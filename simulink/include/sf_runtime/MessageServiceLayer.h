...
LIBMWSF_RUNTIME_API void* slMessageRtRegisterLocalMessageQueueUsingMsgBlock(MsgBlockInfo_t* blkInfo,
                                                                            int queueId,
                                                                            unsigned int ssid);
LIBMWSF_RUNTIME_API void* slMessageRtRegisterInputMessageQueueUsingMsgBlock(MsgBlockInfo_t* blkInfo,
                                                                            int portNum,
                                                                            unsigned int ssid);
LIBMWSF_RUNTIME_API void* slMessageRtRegisterOutputMessageQueueUsingMsgBlock(
    MsgBlockInfo_t* blkInfo,
    int portNum,
    unsigned int ssid);

LIBMWSF_RUNTIME_API void* slMessageRtRegisterLocalMessageQueue(SimStruct* s,
                                                               int queueId,
                                                               unsigned int ssid);
LIBMWSF_RUNTIME_API void* slMessageRtRegisterInputMessageQueue(SimStruct* s,
                                                               int portNum,
                                                               unsigned int ssid);
LIBMWSF_RUNTIME_API void* slMessageRtRegisterOutputMessageQueue(SimStruct* s,
                                                                int portNum,
                                                                unsigned int ssid);

LIBMWSF_RUNTIME_API void slMessageRtDiagnosticCheck(void* msgInterface,
                                                    void* destMsgInterface,
                                                    const char* diagnosticDesc,
                                                    unsigned int ssid,
                                                    int offsetSrcLoc,
                                                    int lengthSrcLoc);
LIBMWSF_RUNTIME_API void slMessageRtSetQueueAttribute(void* msgInterface,
...
LIBMWSF_RUNTIME_API int slMessageRtDesReceive(void* msgInterface,
                                              void** payload,
                                              bool isMsgTrigger);
...
LIBMWSF_RUNTIME_API void sfDebuggerSendMessage(void* msgInterface,
                                               void* msgPayload,
                                               unsigned int msgSSID);
