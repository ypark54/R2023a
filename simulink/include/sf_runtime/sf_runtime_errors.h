...
sf_eml_array_bounds_check_int64(SimStruct* S,
                                unsigned int ssIdOfSourceObject,
                                int offsetInSourceObject,
                                int lengthInSourceObject,
                                int dataNumber,
...
#ifdef INT_TYPE_64_IS_SUPPORTED
LIBMWSF_RUNTIME_API int64_T
sf_eml_shift_index_bounds_check_int64(SimStruct* S,
                                      unsigned int ssIdOfSourceObject,
                                      int offsetInSourceObject,
                                      int lengthInSourceObject,
                                      const char* operandText,
...
#ifdef INT_TYPE_64_IS_SUPPORTED
LIBMWSF_RUNTIME_API int64_T
sf_eml_type_range_check_int64(SimStruct* S,
                              unsigned int ssIdOfSourceObject,
                              int offsetInSourceObject,
                              int lengthInSourceObject,
                              int64_T indexValue,
...
LIBMWSF_RUNTIME_API void sf_report_req_assumption_failed(SimStruct* S,
                                                         uint32_T currentAssumeSsid);
