...
LIBMWSF_RUNTIME_API void sdi_register_half_type_signal(
    struct sdiBlockID* blockId,
    const char* targetName,
    const char* parentStateRelativePath,
    int numDims,
...
LIBMWSF_RUNTIME_API void sdi_register_non_virtual_bus_half_type_leaf(
    struct sdiBlockID* blockId,
    int uMethod,
    unsigned int ssId,
    unsigned int parentsIdx,
...
LIBMWSF_RUNTIME_API void sdi_register_base_address(
    struct sdiBlockID* blockId,
    void* baseAddr,
    unsigned int ssId);
