...
LIBMWSF_RUNTIME_API DTypeId sf_get_fixpt_data_type_id(SimStruct* S, const SfFixptProps* fixptProps);
...
LIBMWSF_RUNTIME_API mxArray* sf_get_dwork_info_from_mat_file(SimStruct* S,
                                                             ...
                                                             unsigned chartFileNumber,
                                                             const char* propName);
LIBMWSF_RUNTIME_API void sf_set_encoded_dwork_info(SimStruct* S, const char* encodedDWorkInfo);
...
LIBMWSF_RUNTIME_API void slcsInvokeSimulinkFunctionVoidArgsWithTryCatch(SimStruct* S,
                                                                          const char* fcnName,
                                                                          int_T numArgs,
                                                                          void* args[]);
...
LIBMWSF_RUNTIME_API void setChartEnableDisableFcn(SimStruct* S, bool aFlag);
...
LIBMWSF_RUNTIME_API void sf_warn_if_symbolic_dimension_param_changed(SimStruct* S);
...
LIBMWSF_RUNTIME_API void sfCallMessageFunction(unsigned int msgSSID,
                                               void* msgInterface,
                                               void* msgPayload,
                                               const char* cmdType);

LIBMWSF_RUNTIME_API void sf_populate_enabled_flags(SimStruct* S, uint8_T* isEnabled);
...
LIBMWSF_RUNTIME_API void sf_call_action_subsys_zeroOutZeroCrossings(SimStruct* S, void* execBlockP);
...
LIBMWSF_RUNTIME_API void sf_warning_changing_param_used_in_symbolic_dimensions(SimStruct* S,
                                                                               unsigned int aId);
LIBMWSF_RUNTIME_API void sf_error_out_about_continuous_sample_time_with_persistent_vars(
    SimStruct* S);
LIBMWSF_RUNTIME_API bool sfHasContStates(SimStruct* S);
LIBMWSF_RUNTIME_API bool supportsLegacyBehaviorForPersistentVarInContinuousTime(SimStruct* S);
...
LIBMWSF_RUNTIME_API bool ssIsModeUpdateTimeStep_wrapper(SimStruct* S);
