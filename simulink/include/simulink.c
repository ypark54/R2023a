...
#define _ssFatalError_1(S,errid,arg1) {                                 \
    mxArray *_prhs[2];                                                   \
    mxArray *_plhs[1] = { NULL };                                        \
    _prhs[0] = (errid);                                                  \
    _prhs[1] = (arg1);                                                   \
    mexCallMATLAB(1, _plhs, (sizeof(_prhs)/sizeof(_prhs[0])), _prhs, "MSLException"); \
    mexCallMATLAB(0, NULL, 1, _plhs, "throw"); }
...
#define _ssWarning_1(S,errid,arg1) {                                    \
    ...
    _prhs[0] = (errid);                                                  \
    _prhs[1] = (arg1);                                                   \
    mexCallMATLAB(1, _plhs, (sizeof(_prhs)/sizeof(_prhs[0])), _prhs, "message"); \
    mexCallMATLAB(0, NULL, 1, _plhs, "warning"); }
...
#ifdef SFCN64
/*SLSize versions*/
int_T _ssSetInputPortMatrixDimensionsSLSize(SimStruct* S, int_T port, SLSize m, SLSize n) {
    int_T status;
    DimsInfo_T dimsInfo = {-1, -1, NULL, NULL};
    SLSize dims[2];
    ...
    return (status);
} /* end _ssSetInputPortMatrixDimensionsSLSize */

int_T _ssSetOutputPortMatrixDimensionsSLSize(SimStruct* S, int_T port, SLSize m, SLSize n) {
    int_T status;
    DimsInfo_T dimsInfo = {-1, -1, NULL, NULL};
    SLSize dims[2];
    ...
    return (status);
} /* end _ssSetOutputPortMatrixDimensionsSLSize */

int_T _ssSetInputPortVectorDimensionSLSize(SimStruct* S, int_T port, SLSize m) {
    int_T status;
    DimsInfo_T dimsInfo = {-1, -1, NULL, NULL};
    ...
    return (status);
} /* end _ssSetInputPortVectorDimensionSLSize */

int_T _ssSetOutputPortVectorDimensionSLSize(SimStruct* S, int_T port, SLSize m) {
    int_T status;
    DimsInfo_T dimsInfo = {-1, -1, NULL, NULL};
    ...
    return (status);
} /* end _ssSetOutputPortVectorDimensionSLSize */

#else

/* Function: __ssSetInputPortMatrixDimensions ======================================================
 * Returns:
...
int_T _ssSetInputPortMatrixDimensions(SimStruct *S, int_T port, int_T m, int_T n)
{
    ...
    if ((m != DYNAMICALLY_SIZED) && (n != DYNAMICALLY_SIZED)) {
        /* if any port dimension is unbounded (denoted by INT_MAX - 1),
           the width should be unbounded as well */
        if (m == INT_MAX - 1 || n == INT_MAX -1) {
            dimsInfo.width = INT_MAX - 1;
        }
        else if (m > INT_MAX/n) {
            /* Dimension overflow */
            return(status = 0);
...
/* Function: _ssRegisterSymbolicDimsMATLABExpr =================================
 * Abstract:
 *    Registers a MATLAB expression string (aMATLABExpr) as a symbolic dimension
 *    and returns its symbolic dimensions id.
 ...
 */
SymbDimsId _ssRegisterSymbolicDimsMATLABExpr(SimStruct* S,
                                             const char_T* aMATLABExpr,
                                             const DimsInfo_AsInt* aDimsInfo) {
    ssSymbolicDimMatlabExprOp val;   
    val.fMATLABExpr = aMATLABExpr;
    val.fDimsInfo = aDimsInfo;
    val.returnValue = SL_NOSYMBDIMS;
    
    /* setting arg1 as 1 for MATLABExpr*/
    _ssSafelyCallGenericFcnStart(S)(
        S, GEN_FCN_REGISTER_SYMBOLIC_DIMS_EXPR, MATLABEXPR, (void*)&val)
        _ssSafelyCallGenericFcnEnd;
    return val.returnValue;
}
...
/* Function: _ssRegisterSymbolicEqualRelation ===================================
 * Abstract:
 *    This function is used to add equal relation between two symbolic dimensions
 */
void _ssRegisterSymbolicEqualRelation(SimStruct* S, const SymbDimsId aLHS, const SymbDimsId aRHS) {
    SymbDimsId val = aRHS;
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_REGISTER_SYMBOLIC_EQUAL_RELATION, aLHS, &val)
        _ssSafelyCallGenericFcnEnd;
}
 ...
 * and integer value
 */
void _ssRegisterSymbolicEqualValue(SimStruct* S, const SymbDimsId aLHS, const int_T aValue) {
    SymbDimsId val = aValue;
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_REGISTER_SYMBOLIC_EQUAL_VALUE, aLHS, &val)
        _ssSafelyCallGenericFcnEnd;
}

/* Function: _ssAmendLeadingSymbolicDims =======================================
 * Abstract:
 *    Create a new symbolic dimension by merging an existing one
 *    and desired dimension, for handling "leading 1" issue
 */
SymbDimsId _ssAmendLeadingSymbolicDims(SimStruct* S, const int_T numDims, const SymbDimsId aDimsId) {
    SymbDimsId val = aDimsId;
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_AMEND_LEADING_SYMBOLIC_DIMS, numDims, &val)
        _ssSafelyCallGenericFcnEnd;
    return val;
}

/* Function: _ssAmendTrailingSymbolicDims =======================================
 * Abstract:
 *    Create a new symbolic dimension by merging an existing one
 *    and desired dimension, for handling "trailing 1" issue
 */
SymbDimsId _ssAmendTrailingSymbolicDims(SimStruct* S, const int_T numDims, const SymbDimsId aDimsId) {
    SymbDimsId val = aDimsId;
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_AMEND_TRAILING_SYMBOLIC_DIMS, numDims, &val)
        _ssSafelyCallGenericFcnEnd;
    return val;
}
...
/* Function: _ssGetDWorkSymbolicDimsId =========================================
 * Abstract:
 *    This function gets the symbolic dimensions id (SymbDimsId)
 *    of a given dwork index.
 */
SymbDimsId _ssGetDWorkSymbolicDimsId(SimStruct *S, 
                                     const int_T aDWorkIdx)
{ 
    SymbDimsId val = SL_NOSYMBDIMS;
    _ssSafelyCallGenericFcnStart(S)(
        S, GEN_FCN_GET_DWORK_SYMBOLIC_DIMS_ID, aDWorkIdx, &val)
        _ssSafelyCallGenericFcnEnd;
    return val;
}

/* Function: _ssSetDWorkSymbolicDimsId =========================================
 * Abstract:
 *    This function sets the symbolic dimensions id (SymbDimsId)
 *    of a given dwork index.
 */
void _ssSetDWorkSymbolicDimsId(SimStruct *S, 
                               const int_T aDWorkIdx, 
                               const SymbDimsId aSymbDimsId)
{ 
    SymbDimsId val = aSymbDimsId;
    _ssSafelyCallGenericFcnStart(S)(
        S, GEN_FCN_SET_DWORK_SYMBOLIC_DIMS_ID, aDWorkIdx, &val)
        _ssSafelyCallGenericFcnEnd;
}

/* Function: _ssGetCompDWorkSymbolicDimsId =====================================
 * Abstract:
 *    This function gets the compiled symbolic dimensions id (SymbDimsId)
 *    of a given dwork index.
 */
SymbDimsId _ssGetCompDWorkSymbolicDimsId(SimStruct *S, 
                                         const int_T aDWorkIdx)
{ 
    SymbDimsId val = SL_NOSYMBDIMS;
    _ssSafelyCallGenericFcnStart(S)(
        S, GEN_FCN_GET_COMP_DWORK_SYMBOLIC_DIMS_ID, aDWorkIdx, &val)
        _ssSafelyCallGenericFcnEnd;
    return val;
}
...
{ 
    SymbDimsId val = aSymbDimsId;
    _ssSafelyCallGenericFcnStart(S)(
        S, GEN_FCN_SET_COMP_DWORK_SYMBOLIC_DIMS_ID, aDWorkIdx, &val)
        _ssSafelyCallGenericFcnEnd;
}
 ...
 */
#ifdef SFCN64
SLSize _ssGetCurrentInputPortWidth(SimStruct *S, int_T pIdx)
{
    SLSize ipWidth = ssGetInputPortWidth(S, pIdx);
    SLSize retWidth;
    if ((ssGetInputPortDimensionsMode(S, pIdx) == VARIABLE_DIMS_MODE) ||
        ssIsDimensionUnbounded(ipWidth)) {
        SLSize currWidth = 1, dIdx;
        for (dIdx = 0; dIdx < (SLSize)ssGetInputPortNumDimensions(S, pIdx); dIdx++) {
...
{
    int_T ipWidth = ssGetInputPortWidth(S, pIdx);
    int_T retWidth;
    if ((ssGetInputPortDimensionsMode(S, pIdx) == VARIABLE_DIMS_MODE) ||
        ssIsDimensionUnbounded(ipWidth)) {
 ...
 */
#ifdef SFCN64
SLSize _ssGetCurrentOutputPortWidth(SimStruct *S, int_T pIdx)
{
    SLSize opWidth = ssGetOutputPortWidth(S, pIdx);
    SLSize retWidth;
    if ((ssGetOutputPortDimensionsMode(S, pIdx) == VARIABLE_DIMS_MODE) ||
        ssIsDimensionUnbounded(opWidth)) {
        SLSize currWidth = 1, dIdx;
...
{
    int_T opWidth = ssGetOutputPortWidth(S, pIdx);
    int_T retWidth;
    if ((ssGetOutputPortDimensionsMode(S, pIdx) == VARIABLE_DIMS_MODE) ||
        ssIsDimensionUnbounded(opWidth)) {
        int_T currWidth = 1, dIdx;
...
static SimStruct *_CreateSimStruct(int_T nrhs, const mxArray *prhs[])
{
    ...
    ssJacobianPerturbationBounds* jacobianPerturbationBounds =
        (ssJacobianPerturbationBounds*) mxCalloc((size_t) 1,sizeof(ssJacobianPerturbationBounds));
    ...
    _ssSetJacobianPerturbationBounds(S, jacobianPerturbationBounds);
...
/* Function: ssWarning ========================================================
 * Abstract:
 *	Call mexWarnMsgTxt to issue the specified warning message
 */
...
/* Function: _ssReadInputStringFcn =====================================
 * Abstract:
 *   Return null-terminated C string from an input port of string type.
 */
#if S_FUNCTION_LEVEL == 2
const char_T* _ssReadInputStringFcn(SimStruct* S, int_T portIdx)
{
    const char_T* str = NULL;
    _ssSafelyCallGenericFcnStart(S)(
        S, GEN_FCN_READ_STRING_INPUT, portIdx, (void*)&str)
        _ssSafelyCallGenericFcnEnd;
    return str;
}
#endif
...
/*
 * Function: _ssGetPointerContainedData =====================================
 * Abstract:
 *   Return contained data of Simulink pointer type data.
 */
#if S_FUNCTION_LEVEL == 2
void* _ssGetPointerContainedData(SimStruct* S, DTypeId dTypeId, void* dataArg)
{
    PointerRec slPointerRec;                                                         
    slPointerRec.dataTypeId = (dTypeId);                                             
    slPointerRec.data = (dataArg);
    slPointerRec.retData = NULL;
    slPointerRec.retWidth = 0;
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_POINTER_CONTAINED_DATA, 0,        
                                    (void*)&slPointerRec) _ssSafelyCallGenericFcnEnd; 
    return slPointerRec.retData;
}
#endif

/*
 * Function: _ssGetPointerContainedDataWidth =====================================
 * Abstract:
 *   Return contained data width of Simulink pointer type data.
 */
#if S_FUNCTION_LEVEL == 2
size_t _ssGetPointerContainedDataWidth(SimStruct* S, DTypeId dTypeId, void* dataArg)
{
    PointerRec slPointerRec;                                                          
    slPointerRec.dataTypeId = (dTypeId);                                
    slPointerRec.data = (dataArg);
...
DTypeId _ssRegisterDynamicArrayDataTypeFcn(SimStruct* S,
                                           DTypeId containedDataTypeId,
                                           int_T containedDataNumDims,
                                           int_T* containedDataDims,
                                           boolean_T containedDataIsComplex) {

    RegisterDynamicArrayDataTypeRec slRegisterDynamicArrayDataTypeRec;
    slRegisterDynamicArrayDataTypeRec.dataTypeId = containedDataTypeId;
    slRegisterDynamicArrayDataTypeRec.retDataTypeId = DYNAMICALLY_TYPED;
    slRegisterDynamicArrayDataTypeRec.dataNumDims = containedDataNumDims;
    slRegisterDynamicArrayDataTypeRec.dataDims = containedDataDims;
    slRegisterDynamicArrayDataTypeRec.dataIsComplex = containedDataIsComplex;

    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_REGISTER_DYNAMIC_ARRAY_DATA_TYPE, 0,
                                    (void*)&slRegisterDynamicArrayDataTypeRec)
        _ssSafelyCallGenericFcnEnd;

    return slRegisterDynamicArrayDataTypeRec.retDataTypeId;
}

size_t _ssGetDynamicArrayContainedDataCurrentWidthFcn(SimStruct* S, DTypeId dtId, void* data) {
    DynamicArrayRec slDynamicArrayRec;
    slDynamicArrayRec.numDims = 0;
    slDynamicArrayRec.width = 0;
    slDynamicArrayRec.data = data;
    ...
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_DYNAMIC_ARRAY_CONTAINED_DATA_CURRENT_WIDTH, 0,
                                    (void*)&slDynamicArrayRec) _ssSafelyCallGenericFcnEnd;
    return slDynamicArrayRec.width;
}

void* _ssGetDynamicArrayContainedDataFcn(SimStruct* S, DTypeId dtId, void* data) {
    DynamicArrayRec slDynamicArrayRec;
    slDynamicArrayRec.numDims = 0;
    slDynamicArrayRec.width = 0;
    slDynamicArrayRec.data = data;
    ...
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_DYNAMIC_ARRAY_CONTAINED_DATA, 0,
                                    (void*)&slDynamicArrayRec) _ssSafelyCallGenericFcnEnd;
    return slDynamicArrayRec.retData;
}

const void* _ssGetInputPortDynamicArrayDataFcn(SimStruct* S, int portIdx) {
    DynamicArrayRec slDynamicArrayRec;
    slDynamicArrayRec.numDims = 0;
    slDynamicArrayRec.width = 0;
    ...
    slDynamicArrayRec.dims = NULL;
    slDynamicArrayRec.constDims = NULL;
    slDynamicArrayRec.dataTypeId = DYNAMICALLY_TYPED;

    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_INPUT_DYNAMIC_ARRAY_DATA, portIdx,
                                    (void*)&slDynamicArrayRec) _ssSafelyCallGenericFcnEnd;
    return slDynamicArrayRec.constData;
}

void* _ssGetOutputPortDynamicArrayDataFcn(SimStruct* S, int portIdx) {
    DynamicArrayRec slDynamicArrayRec;
    slDynamicArrayRec.numDims = 0;
    slDynamicArrayRec.width = 0;
    slDynamicArrayRec.data = NULL;
    ...
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_OUTPUT_DYNAMIC_ARRAY_DATA, portIdx,
                                    (void*)&slDynamicArrayRec) _ssSafelyCallGenericFcnEnd;
    return slDynamicArrayRec.retData;
}

const void* _ssGetInputPortDynamicArrayContainedDataFcn(SimStruct* S, int portIdx) {
    DynamicArrayRec slDynamicArrayRec;
    slDynamicArrayRec.numDims = 0;
    slDynamicArrayRec.width = 0;
    slDynamicArrayRec.data = NULL;
    ...
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_INPUT_DYNAMIC_ARRAY_CONTAINED_DATA, portIdx,
                                    (void*)&slDynamicArrayRec) _ssSafelyCallGenericFcnEnd;
    return slDynamicArrayRec.constData;
}

void* _ssGetOutputPortDynamicArrayContainedDataFcn(SimStruct* S, int portIdx) {
    DynamicArrayRec slDynamicArrayRec;
    slDynamicArrayRec.numDims = 0;
    slDynamicArrayRec.width = 0;
    slDynamicArrayRec.data = NULL;
    ...
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_OUTPUT_DYNAMIC_ARRAY_CONTAINED_DATA, portIdx,
                                    (void*)&slDynamicArrayRec) _ssSafelyCallGenericFcnEnd;
    return slDynamicArrayRec.retData;
}

void* _ssGetDynamicArrayDWorkContainedDataFcn(SimStruct* S, int idx) {
    DynamicArrayRec slDynamicArrayRec;
    slDynamicArrayRec.numDims = 0;
    slDynamicArrayRec.width = 0;
    slDynamicArrayRec.data = NULL;
    ...
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_GET_DYNAMIC_ARRAY_DWORK_CONTAINED_DATA, idx,
                                    (void*)&slDynamicArrayRec) _ssSafelyCallGenericFcnEnd;
...
#   pragma mpwc on
#   endif
    ans = (*S->mdlInfo->writeRTWNameValuePairFcn)(S->mdlInfo->writeRTWFcnArg, type, name, pValue,
                                                  dtInfo, nRows, nCols);
#   if SS_DO_FCN_CALL_ON_MAC && defined(__MWERKS__)
#   pragma mpwc off
#   endif
                              ...
                              ...)
{
    ...
    switch (type) {
      ...
      case SSWRITE_VALUE_QSTR:
        ...
        break;
      case SSWRITE_VALUE_VECT_STR:
        nRows     = va_arg(ap, SLSize);  /* nItems e.g. ["a", "b", "c"] has 3 */
        break;
      case SSWRITE_VALUE_NUM:
      case SSWRITE_VALUE_DTYPE_NUM:
        dtInfo = va_arg(ap, int_T);
      ...
      case SSWRITE_VALUE_DTYPE_VECT:
        dtInfo     = va_arg(ap, int_T);
        nRows      = va_arg(ap, SLSize);
        break;
      case SSWRITE_VALUE_2DMAT:
      case SSWRITE_VALUE_DTYPE_2DMAT:
        dtInfo    = va_arg(ap, int_T);
        nRows     = va_arg(ap, SLSize);
        nCols     = va_arg(ap, SLSize);
        haveNCols = 1;
        break;
      case SSWRITE_VALUE_DTYPE_ML_VECT:
        {
...
#   pragma mpwc on
#   endif
    ans = (*S->blkInfo.blkInfo2->mdlInfoSLSize->writeRTWNameValuePairFcn)(
        S->mdlInfo->writeRTWFcnArg, type, name, pValue, dtInfo, nRows, nCols);
#   if SS_DO_FCN_CALL_ON_MAC && defined(__MWERKS__)
#   pragma mpwc off
#   endif
...
#       pragma mpwc on
#       endif
        ans = (*S->mdlInfo->writeRTWParameterFcn)(S->mdlInfo->writeRTWFcnArg, type, name, str,
                                                  pValue, dtInfo, nRows, nCols);
#       if SS_DO_FCN_CALL_ON_MAC && defined(__MWERKS__)
#       pragma mpwc off
#       endif
...
#       pragma mpwc on
#       endif
        ans = (*S->blkInfo.blkInfo2->mdlInfoSLSize->writeRTWParameterFcn)(
            S->mdlInfo->writeRTWFcnArg, type, name, str, pValue, dtInfo, nRows, nCols);
#       if SS_DO_FCN_CALL_ON_MAC && defined(__MWERKS__)
#       pragma mpwc off
#       endif
                         ...
                         ...)
{
    ...
    if (strcmp(vectName, "RWork") == 0) {
        nElementsExpected = (int_T)ssGetNumRWork(S);
    } else if (strcmp(vectName, "IWork") == 0) {
        nElementsExpected = (int_T)ssGetNumIWork(S);
    }  else if (strcmp(vectName, "PWork") == 0) {
        nElementsExpected = (int_T)ssGetNumPWork(S);
    } else {
    ...
    if (nElementsWritten != nElementsExpected) {
        char_T errmsg[SS_ERROR_STATUS_BUFFER_SIZE];
        (void)sprintf(errmsg,
...
/* ===--------------------------------------------------------------------=== */
#if S_FUNCTION_LEVEL==2
int_T _ssCreateSLCGStringBuffer(SimStruct *S) {
    int_T stringBufferIdx = -1;
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_CREATE_SLCG_STRING_BUFFER, 0, &stringBufferIdx) \
        _ssSafelyCallGenericFcnEnd;
    return stringBufferIdx;
}
void _ssAddToSLCGStringBuffer(SimStruct *S, int_T aStringBufferIdx, char* aString) {
    _ssSafelyCallGenericFcnStart(S)(S, GEN_FCN_ADD_TO_SLCG_STRING_BUFFER, aStringBufferIdx, aString) \
        _ssSafelyCallGenericFcnEnd;
}
#endif
/* ===--------------------------------------------------------------------=== */
...
#if S_FUNCTION_LEVEL == 2 && defined(MDL_PRE_INITIALIZE)
  static void __mdlPreInitialize(SimStruct *S)
  {
      REQUIRE_LOCAL_STACK_FRAME;
      mdlPreInitialize(S);
  }
...
#if S_FUNCTION_LEVEL == 2 && defined(MDL_COPY_RTP_DATA)
static void __mdlCopyRTPData(SimStruct *S, int_T prmIdx, void** rtpData)
  {
      REQUIRE_LOCAL_STACK_FRAME;
      mdlCopyRTPData(S, prmIdx, rtpData);
  }
#endif
...
#if S_FUNCTION_LEVEL == 2 && defined(MDL_OPERATING_POINT)

static mxArray* __mdlGetOperatingPoint(SimStruct *S){
    REQUIRE_LOCAL_STACK_FRAME;
    return mdlGetOperatingPoint(S);
}

static void __mdlSetOperatingPoint(SimStruct *S, const mxArray* op){
    REQUIRE_LOCAL_STACK_FRAME;
    mdlSetOperatingPoint(S,op);
}
...
#if S_FUNCTION_LEVEL == 2 && defined(MDL_PRE_INITIALIZE)
# define __mdlPreInitialize       mdlPreInitialize
#endif

#if S_FUNCTION_LEVEL == 2 && defined(MDL_COPY_RTP_DATA)
# define __mdlCopyRTPData         mdlCopyRTPData
#endif
...
#           if S_FUNCTION_LEVEL==2 && defined(MDL_COPY_RTP_DATA)
              ssSetmdlCopyRTPData(S,__mdlCopyRTPData);
#           endif
...
#           if S_FUNCTION_LEVEL==2 && defined(MDL_OPERATING_POINT)
              ssSetmdlGetOperatingPoint(S, __mdlGetOperatingPoint);
              ssSetmdlSetOperatingPoint(S, __mdlSetOperatingPoint);
#           endif  
...
#         if S_FUNCTION_LEVEL == 2
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_WIDTH:
            if (ssGetmdlSetInputPortWidth(S) != NULL) {
                ...
                if (ssGetSFcnBitness(S) == SS_32BIT) {
                    int_T width = ssGetMexApiInt2(S);
                    sfcnSetInputPortWidthAsInt(S, port, width);
                } else {
                    SLSize width = ssGetMexApiSLSize2(S);
          ...
          case SS_CALL_MDL_SET_OUTPUT_PORT_WIDTH:
              if (ssGetmdlSetOutputPortWidth(S) != NULL) {
                  ...
                  if (ssGetSFcnBitness(S) == SS_32BIT) {
                      int_T width = ssGetMexApiInt2(S);
                      sfcnSetOutputPortWidthAsInt(S, port, (int_T)width);
                  } else {
                      SLSize width = ssGetMexApiSLSize2(S);
                  ...
                  (void)sprintf(
                      errmsg,
                      _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall",
                                              _StrArg(%s)),
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_DIMENSION_INFO:
            if (ssGetmdlSetInputPortDimensions(S) != NULL) {
                int_T            port      = ssGetMexApiInt1(S);
                if (ssGetSFcnBitness(S) == SS_32BIT) {
                    sfcnSetInputPortDimensionInfoAsInt(S, port,
                                                  (const DimsInfo_AsInt*)ssGetMexApiVoidPtr1(S));
                } else {
                    sfcnSetInputPortDimensionInfo(S, port,
                                                  (const DimsInfo_AsSLSize*)ssGetMexApiVoidPtr1(S));
                }
            } else {
          ...
          case SS_CALL_MDL_SET_OUTPUT_PORT_DIMENSION_INFO:
            if (ssGetmdlSetOutputPortDimensions(S) != NULL) {
                int_T            port      = ssGetMexApiInt1(S);
                if (ssGetSFcnBitness(S) == SS_32BIT) {
                    sfcnSetOutputPortDimensionInfoAsInt(S, port,
                                                  (const DimsInfo_AsInt*)ssGetMexApiVoidPtr1(S));
                } else {
                    sfcnSetOutputPortDimensionInfo(S, port,
                                                  (const DimsInfo_AsSLSize*)ssGetMexApiVoidPtr1(S));
                }
            } else {
          ...
          case SS_CALL_MDL_SET_INPUT_PORT_SYMBOLIC_DIMENSIONS:
            if (ssGetmdlSetInputPortSymbolicDimensions(S) != NULL) {
                int_T            port      = ssGetMexApiInt1(S);
          ...
          case SS_CALL_MDL_SET_OUTPUT_PORT_SYMBOLIC_DIMENSIONS:
            if (ssGetmdlSetOutputPortSymbolicDimensions(S) != NULL) {
                int_T            port      = ssGetMexApiInt1(S);
                SymbDimsId       dimsId    = ssGetMexApiInt2(S);
...
#         endif
        ...
        case SS_CALL_MDL_PRE_INITIALIZE:
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_PRE_INITIALIZE)
            ssSetmdlPreInitialize(S, __mdlPreInitialize);
            mdlPreInitialize(S);
#         endif
        break;
...
#         if S_FUNCTION_LEVEL == 2 && defined(MDL_COPY_RTP_DATA)
          case SS_CALL_MDL_COPY_RTP_DATA:
              if (ssGetmdlCopyRTPData(S) != NULL) {
                  int_T portIdx = ssGetMexApiInt1(S);
                  void **rtpData = (void**)ssGetMexApiVoidPtr1(S);
                  mdlCopyRTPData(S, portIdx, rtpData);
              } else {
                  (void)sprintf(errmsg, _SimstructErrmsgWithArg("Simulink:SFunctions:SimStructUnexpectedFunctionCall", _StrArg(%s)), "mdlCopyRTPData");
                  _ssCopyErrorStatusToBuffer(S, errmsg, strlen(errmsg) + 1);
              }
              break;
#         endif          
...
DEPRECATED SimStruct* ssGetRootSS(SimStruct* S) {
    /* Only warn once during simulation */
    static bool warningGuard = 0;
    if (!warningGuard) {
        _ssWarning_1(S, _mxStrArg("Simulink:SFunctions:InvalidRootSimStructAccess"),
                     _mxStrArg(_sfcnName));
        warningGuard = 1;
    }
    return (S)->root;
...
DEPRECATED SimStruct* ssGetParentSS(SimStruct* S) {
    /* Only warn once during simulation */
    static bool warningGuard = 0;
    if (!warningGuard) {
        _ssWarning_1(S, _mxStrArg("Simulink:SFunctions:InvalidParentSimStructAccess"),
                     _mxStrArg(_sfcnName));
        warningGuard = 1;
    }
    return (S)->parent;
...
/* LocalWords:  LINTLIBRARY dstates tnext nonsampled Symb nosymbdims SFunc zerocross UFcn UPtrs
 * LocalWords:  DType Wxxx SSWRITE vect DMAT un QSTR CArray RValue IValue CMatrix RWork IWork PWork
 * LocalWords:  MRC Sfunction xts sfunc RTP Wcast qual Undefs
 */
