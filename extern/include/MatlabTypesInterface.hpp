...
// If C++ engine headers are specified, use engine's version of feval.
// Otherwise, default to using compiler SDK version of feval.
#ifdef MATLABENGINE_HPP
...
namespace MatlabTypesInterface {
    ...
    /// Gets a string
    inline std::u16string convertStringScalar(matlab::data::Array arr) {
...
class MATLABObject {
  public:
    ...
    MATLABObject(std::shared_ptr<ControllerType> matlabPtr, std::u16string clsName)
        : m_matlabPtr(matlabPtr) {
        m_object = MATLABCallDefaultConstructor(clsName);
    }

    MATLABObject(std::shared_ptr<ControllerType> matlabPtr, matlab::data::Array obj)
        : m_matlabPtr(matlabPtr)
        , m_object(obj) {
    }
  ...
  protected:
    ...
    /**
     *  @brief Gets the specified scalar MATLAB property belonging to this object. Handles gets that
     * might return as complex.
     *  @param propName - The name of the property in MATLAB
    ...
    inline void MATLABSetVectorProperty(std::u16string propName, std::vector<T> value) {
        ...
        MATLABSetArrayProperty(propName,
                               arrayFactory.createArray<typename std::vector<T>::const_iterator, T>(
                                   {value.size(), size_t(1)}, value.cbegin(), value.cend()));
    }
    ...
    inline matlab::data::Array MATLABGetArrayProperty(std::u16string propName) {
        ...
        matlab::data::StructArray subsArray =
            arrayFactory.createStructArray({1, 1}, {"type", "subs"});
     ...
     * or C++ Engine API.
     */
    inline void MATLABCallNoOutputMethod(std::u16string fcn,
     ...
     * or C++ Engine API.
     */
    inline matlab::data::Array MATLABCallOneOutputMethod(std::u16string fcn,
                                                         std::vector<matlab::data::Array> args) {
     ...
     * or C++ Engine API.
     */
    inline std::vector<matlab::data::Array> MATLABCallMultiOutputMethod(
        std::u16string fcn,
        size_t nOut,
        std::vector<matlab::data::Array> args) {
  ...
  private:
    /**
     *  @brief Initializes the underlying MATLAB object by creating it in MATLAB via it's default
     * constructor
...
template <>
template <>
inline char16_t MATLABObject<MATLABControllerType>::MATLABGetScalarProperty(
    std::u16string propName) {
    matlab::data::TypedArray<char16_t> charResult =
        MATLABObject<MATLABControllerType>::MATLABGetArrayProperty(propName);
    return charResult[0];
}
...
template <>
template <>
inline void MATLABObject<MATLABControllerType>::MATLABSetScalarProperty(std::u16string propName,
                                                                        char16_t value) {
    matlab::data::ArrayFactory arrayFactory;
    std::u16string str(1, value);
    MATLABObject<MATLABControllerType>::MATLABSetArrayProperty(propName,
                                                               arrayFactory.createCharArray(str));
}

/// Gets a string
template <>
template <>
inline std::u16string MATLABObject<MATLABControllerType>::MATLABGetScalarProperty(
    std::u16string propName) {
...
inline void MATLABObject<MATLABControllerType>::MATLABSetScalarProperty(std::u16string propName,
    ...
    matlab::data::ArrayFactory arrayFactory;
    MATLABObject<MATLABControllerType>::MATLABSetArrayProperty(propName,
                                                               arrayFactory.createCharArray(value));
}

/// Gets a vector of strings
template <>
template <>
inline std::vector<std::u16string> MATLABObject<MATLABControllerType>::MATLABGetVectorProperty(
    std::u16string propName) {
...
/// Gets a vector of objects
template <>
template <>
inline std::vector<matlab::data::Object>
MATLABObject<MATLABControllerType>::MATLABGetVectorProperty(std::u16string propName) {
    matlab::data::ObjectArray arr = MATLABGetArrayProperty(propName);
    std::vector<matlab::data::Object> value(arr.cbegin(), arr.cend());
    return value;
}
...
template <>
template <>
inline void MATLABObject<MATLABControllerType>::MATLABSetVectorProperty(
    std::u16string propName,
    std::vector<std::u16string> value) {
    matlab::data::ArrayFactory arrayFactory;
    size_t numel = value.size();
    matlab::data::StringArray strArray =
        arrayFactory.createArray<matlab::data::MATLABString>({1, numel});
    std::copy(value.begin(), value.end(), strArray.begin());
    MATLABObject<MATLABControllerType>::MATLABSetArrayProperty(propName, strArray);
}

/// Sets a vector of objects
template <>
template <>
inline void MATLABObject<MATLABControllerType>::MATLABSetVectorProperty(
    std::u16string propName,
    std::vector<matlab::data::Object> value) {
    matlab::data::ArrayFactory arrayFactory;
    size_t numel = value.size();
    matlab::data::ObjectArray objArray =
        arrayFactory.createArray({1, numel}, value.begin(), value.end());
    MATLABObject<MATLABControllerType>::MATLABSetArrayProperty(propName, objArray);
}
...
template <>
template <>
inline matlab::data::Array MATLABObject<MATLABControllerType>::MATLABGetScalarProperty(
    std::u16string propName) {
