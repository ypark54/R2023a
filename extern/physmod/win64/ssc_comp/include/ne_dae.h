...
NeCustomDataSize;typedef struct NeCustomDataTag NeCustomData;typedef struct
NeDaeTag NeDae;typedef struct NeRealFunctorDataTag NeRealFunctorData;typedef
struct NeRealFunctorTag NeRealFunctor;typedef enum SscDiagnosticSettingTag{
...
SscLoggingSettingTag{SSC_LOGGING_INVALID= -1,SSC_LOGGING_OFF,SSC_LOGGING_ON,
SSC_LOGGING_LOCAL,SSC_LOGGING_NUM}SscLoggingSetting;typedef struct
NeModelParametersTag NeModelParameters;typedef enum NeSolverTypeTag{
NE_SOLVER_TYPE_INVALID= -1,NE_SOLVER_TYPE_DAE,NE_SOLVER_TYPE_ODE,
NE_SOLVER_TYPE_DISCRETE,NE_SOLVER_TYPE_NUM}NeSolverType;typedef enum
NeModifyAbsTolTag{NE_MODIFY_ABS_TOL_INVALID= -1,NE_MODIFY_ABS_TOL_NO,
NE_MODIFY_ABS_TOL_YES,NE_MODIFY_ABS_TOL_MAYBE,NE_MODIFY_ABS_TOL_NUM}
NeModifyAbsTol;struct NeModelParametersTag{NeSolverType mSolverType;real_T
mSolverTolerance;real_T mSolverAbsTol;real_T mSolverRelTol;boolean_T
mVariableStepSolver;boolean_T mIsUsingODEN;NeModifyAbsTol mSolverModifyAbsTol;
real_T mFixedStepSize;real_T mStartTime;boolean_T mLoadInitialState;boolean_T
mUseSimState;boolean_T mLinTrimCompile;SscLoggingSetting mLoggingMode;real_T
mRTWModifiedTimeStamp;boolean_T mZcDisabled;boolean_T mUseModelRefSolver;};
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "pm_std.h"
...
mReals;}NeParameterInfo;typedef struct NeProfilerTag NeProfiler;
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "pm_std.h"
