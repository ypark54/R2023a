...
extern "C" {
#endif /* __cplusplus */
typedef struct NeDaeTag NeDae;typedef struct NeProfilerTag NeProfiler;typedef
struct NeSolverSystemTag NeSolverSystem;
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "pm_std.h"
...
boolean_T mZcDisabled;boolean_T mUseModelRefSolver;};typedef struct
...
enum NeIndexReductionMethodTag{NE_INVALID_IR_METHOD= -1,NE_NONE_IR,
NE_DERIVATIVE_REPLACEMENT_IR,NE_PROJECTION_IR,NE_NUM_IR_METHOD}
NeIndexReductionMethod;typedef enum NeLinearAlgebraChoiceTag{
NE_INVALID_LA_CHOICE= -1,NE_AUTO_LA,NE_SPARSE_LA,NE_FULL_LA,NE_NUM_LA_CHOICES}
...
NE_PARTITIONING_METHOD_MERGE,NE_PARTITIONING_METHOD_MULTICORE,
NE_PARTITIONING_METHOD_NUM}NePartitionMethod;typedef enum
NeConsistencySolverTag{NE_CONSISTENCY_SOLVER_INVALID= -1,NE_CS_NEWTON_FTOL,
NE_CS_NEWTON_XTOL,NE_CS_NEWTON_XTOL_AFTER_FTOL,NE_CONSISTENCY_SOLVER_NUM}
NeConsistencySolver;typedef enum NeToleranceSourceTag{
...
DaeDynamicInfoWrapper*,const NeSystemInput*,size_t,boolean_T,boolean_T);void(*
mReportMode)(const DaeDynamicInfoWrapper*,const NeSystemInput*,boolean_T,
boolean_T,boolean_T,int16_T);void(*mPushInfo)(const DaeDynamicInfoWrapper*,
size_t);void(*mInitializeState)(DaeDynamicInfoWrapper*,McMatrixFunction*,
McMatrixFunction*,McMatrixFunction*,McMatrixFunction*,McMatrixFunction*,
McRealFunction*,McRealFunction*,size_t,size_t,size_t,size_t);void(*mDestroy)(
...
const NeSystemInput*,PmRealVector*);typedef PmfMessageId(*VslsSupportMethod)(
const PmRealVector*);typedef void(*EventIterationDiagMethod)(const
NeSolverSystem*,const NeSystemInput*,const PmRealVector*d,const PmIntVector*q,
PmCharVector);typedef struct NeSolverSupportMethodsTag{DiagnosisSupportMethod
...
extern "C" {
#endif /* __cplusplus */
void neu_diagnostic_tree_warning(const NeuDiagnosticTree*tree);typedef struct
SscRTWLogFcnManagerTag SscRTWLogFcnManager;typedef struct
...
mRtwLogFcn)(SscRTWLogFcnManager*,real_T timeStep,real_T const*voidInputs,
double*buffer);void(*mRtwDestroy)(SscRTWLogFcnManager*);
SscRTWLogFcnManagerObject*mRtwObject;};typedef struct NeOutputParametersTag{
size_t mDaeIndex;size_t mOutputFunctionIndex;}NeOutputParameters;
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "pm_std.h"
...
NESL_SIM_LINJACOBIAN,NESL_SIM_SOLJACOBIAN,NESL_SIM_LINJACOBIANIRJC,
NESL_SIM_SOLJACOBIANIRJC,NESL_SIM_RESIDUALS,NESL_SIM_TOLERANCES,
NESL_SIM_REINIT,NESL_SIM_NUMJAC_DX_BOUNDS,NESL_SIM_PUSHINFO,
...
mRtwLogFcnManager)(const NeslSimulatorGroup*g,size_t i);NeslSimulatorGroup*(*
mClone)(const NeslSimulatorGroup*g);void(*mGetReference)(NeslSimulatorGroup*g)
;void(*mReleaseReference)(NeslSimulatorGroup*g);const NeProfiler*mProfiler;
NeslSimulatorGroupData*mData;size_t mNumSimulators[NESL_SIMULATOR_CATEGORY_NUM
];size_t mNumRtpManagers;size_t mNumRtwLogFcnManagers;};PmfMessageId
...
rtpDaes,const size_t numRtwLoggingDaes,const int*rtwLoggingDaes);typedef struct
...
NeslSimulatorGroupRegistry*registry,const char*key,size_t idx);boolean_T(*
mHasBeenCloned)(const NeslSimulatorGroupRegistry*registry,const char*key);void
(*mClear)(const NeslSimulatorGroupRegistry*registry);void(*mDestroy)(
...
PmRealVector mDUY;PmRealVector mXP0;PmRealVector mZC;PmIntVector mASSERT;
PmIntVector mPASSERT;PmIntVector mIASSERT;PmRealVector mSO;PmRealVector mSP;
PmIntVector mMODE;PmIntVector mUDOT_REQ;PmRealVector mDELAYS;PmBoolVector
mDXF_V_X;PmBoolVector mDUF_V_X;PmRealVector mOBS_EXP;PmRealVector mOBS_ACT;
PmRealVector mEQ_TOL;PmRealVector mNUMJAC_DX_LO;PmRealVector mNUMJAC_DX_HI;}
...
NE_DAE_METHOD_FREQS,NE_DAE_METHOD_DUY_P,NE_DAE_METHOD_TDUY_P,NE_DAE_METHOD_DUY
,NE_DAE_METHOD_XP0,NE_DAE_METHOD_ZC,NE_DAE_METHOD_ASSERT,NE_DAE_METHOD_PASSERT
...
NE_DAE_METHOD_EQ_TOL,NE_DAE_METHOD_NUMJAC_DX_LO,NE_DAE_METHOD_NUMJAC_DX_HI,
NE_NUM_DAE_METHODS}NeDaeMethodId;typedef enum NeDaeSolveIdTag{
NE_DAE_SOLVE_INVALID= -1,NE_DAE_SOLVE_IC_MODE,NE_DAE_SOLVE_IC_LIS,
NE_DAE_SOLVE_IC_LSS,NE_DAE_SOLVE_CIC_MODE,NE_DAE_SOLVE_CONSAT,NE_DAE_SOLVE_CIC
,NE_DAE_SOLVE_RESET,NE_DAE_SOLVE_NUDGE,NE_DAE_SOLVE_NUM}NeDaeSolveId;typedef
PmfMessageId(*NeDaeMethod)(const NeDae*,const NeSystemInput*,NeDaeMethodOutput
...
const NeDae*,const NeSystemInput*);typedef void(*NeDaeReportFcn)(const NeDae*)
;typedef PmfMessageId(*NeDaeLinearizeFcn)(const NeDae*,const NeSystemInput*,
...
;size_t mNumInitialAssertRanges;size_t mNumSamples;size_t mNumFreqs;size_t
mNumDelays;size_t mNumDxfNzMax;size_t mNumDufNzMax;size_t mNumDtfNzMax;size_t
mNumDxyNzMax;size_t mNumDuyNzMax;size_t mNumTDuyNzMax;size_t mNumDtyNzMax;
size_t mNumDxmNzMax;size_t mNumDumNzMax;size_t mNumObservables;size_t
...
boolean_T mHasConstraints;boolean_T mHasConstraintEquations;boolean_T
mSupportsLinearization;boolean_T mIsDae;boolean_T mIsContinuousLti;boolean_T
mIsSwitchedLinear;boolean_T mIsDfAnalytic;boolean_T mIsDmAnalytic;boolean_T
mIsDyAnalytic;real_T mFundamentalSampleTime;size_t mRefCount;boolean_T
mIsNormalizable;NeEquationData*mEquationData;NeVariableData*mVariableData;
NeVariableData*mDiscreteData;NeModeData*mMajorModeData;NeZCData*mZCData;
NeAssertData*mAssertData;NeAssertData*mParamAssertData;NeAssertData*
mInitialAssertData;NeRange*mRanges;NeRange*mEquationRanges;NeRange*
mAssertRanges;NeRange*mParamAssertRanges;NeRange*mInitialAssertRanges;
NeObservableData*mObservableData;NeParameterInfo mParameterInfo;const
PmBoolVector*mDirectFeedthrough;const PmIntVector*mOutputFunctionMap;size_t
mNumIo[NUM_IO_TYPES];const SscIoInfo*mIo[NUM_IO_TYPES];NeChecksum*mChecksum;
NeProfiler*mProfiler;NeDaePrivateData*mPrivateData;void(*mDestroy)(NeDae*);
NeDae*(*mCloneFcn)(const NeDae*);NeDaeMethod mMethods[NE_NUM_DAE_METHODS];
NeDaeSolve mSolves[NE_DAE_SOLVE_NUM];NeDaeSolve mCheck;NeDaeSetParameters
mSetParameters;NeDaeFunction mPreTrDiagnoseFcn;NeDaeFunction mPreDcDiagnoseFcn
;NeDaeReportFcn mPushInfo;NeDaeSolve mAllInputsWorkFcn;NeDaeLinearizeFcn
mResidualsFcn;NeDaeLinearizeFcn mLinearizeFcn;PmfMessageId(*mInitializeFcn)(
...
dae,input,LinJacobian,mgr);}PMF_DEPLOY_STATIC PmfMessageId ne_dae_residuals(
const NeDae*daePtr,const NeSystemInput*inputPtr,PmRealVector*residualsRvPtr,
NeuDiagnosticManager*mgr){return daePtr->mResidualsFcn(daePtr,inputPtr,
residualsRvPtr,mgr);}PMF_DEPLOY_STATIC PmfMessageId ne_dae_call_method(const
NeDae*dae,NeDaeMethodId id,const NeSystemInput*input,NeDaeMethodOutput*output,
