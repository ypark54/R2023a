...
(*mDestroy)(CStateManager*);CStateManagerData*mData;};typedef enum
...
SscLoggingSetting;typedef struct NeModelParametersTag NeModelParameters;
...
mZcDisabled;boolean_T mUseModelRefSolver;};typedef struct NeSolverParametersTag
